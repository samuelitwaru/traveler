...
Revision ID: 5a9fb72f8468
Revises: 
Create Date: 2020-09-07 08:47:12.316984
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['grid_id'], ['grid.id'], ondelete='SET NULL'),
    ...
    sa.Column('grid_type', sa.Integer(), nullable=True),
